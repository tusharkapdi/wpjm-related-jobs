<?php
/**
 * WP Job Manager Related Jobs Shortcodes
 *
 * (1) Related Job
 */
...
//
/*-----------------------------------------------------------------------------------*/
// length="250"                 ------  content character length
// columns="3"                  ------  split the results into X number of columns (6 max)
// limit="6"                    ------  number of jobs to display
/*-----------------------------------------------------------------------------------*/

// Example: [WPJM_RELATED_JOBS limit="3" columns="3" length="250"]

/*-----------------------------------------------------------------------------------*/

function wpjm_related_jobs_shortcode($atts, $content = null) {
